...
├── phase2/                        ← deferred creature + adaptation normative spec
│   └── creatures-spec-v1.md
...
4. [`phase2/creatures-spec-v1.md`](phase2/creatures-spec-v1.md) — phase-2 creatures + adaptation (normative when that phase starts)  
5. [`reference/north-star.md`](reference/north-star.md) — vision, rationale, worked examples  
